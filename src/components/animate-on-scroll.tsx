...
export function AnimateOnScroll({ children, className, ...props }: AnimateOnScrollProps) {
  ...
  return (
    <section
      ...
      className={cn(
        'transform-gpu transition-all duration-700 ease-in-out data-[state=closed]:opacity-0 data-[state=closed]:translate-y-5 data-[state=open]:opacity-100 data-[state=open]:translate-y-0 py-16 md:py-24',
        className
      )}
      {...props}
    >
