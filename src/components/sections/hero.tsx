    ...
    <section className="relative overflow-hidden py-20 md:py-32" id="home">
      <div className="container mx-auto max-w-7xl px-4 md:px-6">
        <div className="flex flex-col items-center text-center">
          <Avatar className="h-28 w-28 border-4 border-primary/50 mb-6 md:h-32 md:w-32">
            <AvatarImage
          ...
          <h1 className="font-headline text-4xl font-bold tracking-tighter sm:text-5xl md:text-6xl lg:text-7xl min-h-[56px] sm:min-h-[84px] md:min-h-[100px] lg:min-h-[128px]">
            {typedName}
          ...
          <p className="mt-4 max-w-2xl text-base text-foreground/80 md:text-xl">
          ...
          <div className="mt-8 flex flex-col sm:flex-row w-full max-w-sm sm:max-w-none sm:w-auto justify-center gap-4">
          ...
          <div className="mt-6 flex items-center justify-center gap-2 md:mt-8 md:gap-4">
            <Button asChild variant="ghost" size="icon">
              <a href="https://github.com/HelpingCoder7" target="_blank" rel="noopener noreferrer">
                <Github className="h-6 w-6 text-accent md:h-7 md:w-7" />
                <span className="sr-only">GitHub</span>
              </a>
            </Button>
            <Button asChild variant="ghost" size="icon">
              <a href="mailto:sudarshanshrivastava7@gmail.com">
                <Mail className="h-6 w-6 text-accent md:h-7 md:w-7" />
